...
public class ServiceNames {
    ...
    //    擦除后的保存地图
    public static String saveExtMap = "save_ext_map";
    ...
    //    更新导航点
    public static String UpdatePoint = "point_update";

    //    去导航点
    public static String Goal = "set_goal";

    //    跨楼层版导航
    public static String NaviGoal = "navi_targegoalplan";

    //    增加虚\删除拟墙
    public static String ShapeService = "set_shape";

    //    增加\删除区域
    public static String RegionService = "set_region";
